...
<body onload="totala()">
        ...
        <div id="subtotal">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td id='tot' onload="totala()"><strong>RM</strong></td>
                </tr>
            </table>
    ...
    <footer class="section-p1">
        <div class="col">
            <img class="logo" src="imaeg2/MOONSTARBLACK.png" />
            <h4>Contact</h4>
            <p>
...
function subprice() {
    ...
    for (var i = 0; i < qty.length; i++) {
        ...
        var price = parseFloat(pri[i].innerText.replace('RM', '').trim());  // Remove 'RM' and parse as number
        if (isNaN(price)) {
            price = 0;  // Ensure price is a number, fallback to 0 if parsing fails
        }
        sub[i].innerHTML = `RM${(quantity * price).toFixed(2)}`;  // Display two decimal places
...
function totala() {
    ...
    document.getElementById('tot').innerHTML = 'RM' + total.toFixed(2); // Display total with 2 decimal places
    document.getElementById('tot1').innerHTML = 'RM' + total.toFixed(2); // Display total with 2 decimal places
}
